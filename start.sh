...
COMMAND_BASE="./ore-mine-pool-linux worker --route-server-url ws://tw-pool.com:5487/ --server-url 'public&stake' --worker-wallet-address ${WORKER_WALLET_ADDRESS} >> worker.log 2>&1"
