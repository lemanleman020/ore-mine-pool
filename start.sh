...
COMMAND_BASE="./ore-mine-pool-linux worker --route-server-url http://route.oreminepool.top:8080/ --server-url 'public&stake' --threads 96 --worker-wallet-address ${WORKER_WALLET_ADDRESS} >> worker.log 2>&1"
